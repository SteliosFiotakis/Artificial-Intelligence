...
class CriticNetwork(keras.Model):
    def __init__(self, fc1_dims, fc2_dims, name):
...
class Agent:
    def __init__(self, alpha, beta, input_dims, tau, env,
        ...
        self.cnt = 0
        self.model_path = "Saves/BipedalWalker-v3/"
    ...
    def save_models(self):
        ...
        self.actor.save(self.model_path + f"Actor_{self.cnt}", save_format="tf")
        self.critic_1.save(self.model_path + f"Critic1_{self.cnt}", save_format="tf")
        self.critic_2.save(self.model_path + f"Critic2_{self.cnt}", save_format="tf")
        self.target_actor.save(self.model_path + f"TargetActor_{self.cnt}", save_format="tf")
        self.target_critic_1.save(self.model_path + f"TargetCritic1_{self.cnt}", save_format="tf")
        self.target_critic_2.save(self.model_path + f"TargetCritic2_{self.cnt}", save_format="tf")
