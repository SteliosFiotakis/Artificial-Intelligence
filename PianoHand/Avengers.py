...
# Right Hand
dg3_up = np.asarray([-0.1,  -0.4,   0.4,   0.1,   0.7,   0.2,   0.2,   0.3,   0.15,  0.3 ,  0.6 ,  0.,
                      0.1,   0.2,   0.2,   0. ,   0.4,   0.1,  -0.5,  -0.3,   0.17,  0.11, -0.05,])
dg3_down = np.asarray([-0.1,  -0.4,   0.4,   0.3,   0.7,   0.2,   0.2,   0.3,   0.1 ,  0.8 ,  0.6 ,  0.,
                        0.1,   0.2,   0.2,   0. ,   0.7,   0.1,  -0.5,  -0.3,   0.17,  0.11, -0.05,])
dsharpg3_down = np.asarray([-0.1,  -0.4,   0.4,   0.7,   0.5,   0.2,   0.2,   0.3,   0.1 ,  0.5 ,  0.6 ,  0.,
                             0.1,   0.2,   0.2,   0. ,   0.7,   0.1,  -0.5,  -0.3,   0.17,  0.11, -0.05,])
dsharpe3_up = np.asarray([-0.1,  -0.1,   0.4,   0.3,   0.5,   0.2,   0.2,   0.3,   0.15,  0.3 ,  0.6 ,  0.,
                           0.1,   0.2,   0.2,   0.2,   0.8,   0. ,  -0.5,  -0.3,   0.17,  0.12,  0.01,])
dsharpe3_down = np.asarray([-0.1,  -0.1,   0.4,   0.3,   0.5,   0.2,   0.2,   0.3,   0.15,  0.3 ,  0.6 ,  0.,
                             0.1,   0.2,   0.2,   0.2,   0.8,   0. ,  -0.5,  -0.3,   0.17,  0.12, -0.02,])


# Duration
beat = 0.25  # 120 BPM / 2 BPS / 0.5 SPB (B=Beats, P=Per, M=Minutes, S=Seconds)
...
async def sequence():
    ...
    data.ctrl[right_hand] = dg3_up
    await asyncio.sleep(sixteenth)
    data.ctrl[right_hand] = dsharpg3_down
    await asyncio.sleep(sixteenth)
    data.ctrl[right_hand] = dg3_up
    await asyncio.sleep(sixteenth)
    data.ctrl[right_hand] = dsharpg3_down
