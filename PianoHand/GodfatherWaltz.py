...
def dotted(note_value):
    return note_value + note_value / 2
...
async def sequence_():
    ...
    data.ctrl[left_hand] = d2_p
    await asyncio.sleep(quarter)
    data.ctrl[left_hand] = d2_f
    await asyncio.sleep(sixteenth)
    data.ctrl[left_hand] = dfa3_f
    await asyncio.sleep(half)
    data.ctrl[left_hand] = dfa3_p
    await asyncio.sleep(dotted(sixteenth))
    data.ctrl[left_hand] = dfa3_f
    await asyncio.sleep(quarter)
    data.ctrl[left_hand] = dfa3_p
    await asyncio.sleep(dotted(sixteenth))
...
async def main():
    ...
    task2 = asyncio.create_task(sequence_())
